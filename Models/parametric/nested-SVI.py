...
def run_inference(model, guide, age, space, time, lookup12, lookup23, population, deaths, rng_key, args):
...
def main(args):
	...
	svi_result = run_inference(model, guide, a, s3, t, lookup12, lookup23, population, deaths, rng_key, args)
...
if __name__ == "__main__":
	...
	parser.add_argument("--num-svi-steps", type=int, default=100000)
	parser.add_argument("--learning-rate", nargs="?", default=1e-4, type=int)
